...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () =>{
        describe('when the chain does not start with a genisis block', () => {
            it('returns false', () => {
        ...
        describe('when the chain starts with a genisis block and has multiple blocks', () => {
            beforeEach(() => {
            ...
            describe('and the chain contains a block with an invalid feild', () => {
                it('returns false', () => {
                    blockchain.chain[2] = 'some-bad-data';
